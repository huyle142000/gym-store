...
import AddEditChildSubCategory from './AddEditChildSubCategory/AddEditChildSubCategory'

const IconStyled: any = styled("img")({
    cursor: 'pointer'
})

const ChildSubCategoryManagement = () => {
            ...
            <Grid container spacing={6} sx={{ width: '100%' }}>
                ...
                {drawer && <Drawer
                    ...
                    <Box id="drawer-content" sx={{ maxHeight: '100%', overflowY: 'auto' }}>
                        <AddEditChildSubCategory onCloseDrawer={() => onCloseDrawer()} panelId={selectedId} drawer={drawer} storeProductCategory={subCategoryList} onSearch={onSearch} />
                    </Box>
                </Drawer>}
                {/* PopUpDetele */}
                <NotifyFunction
...
export default ChildSubCategoryManagement
